...
func TestAdd(t *testing.T) {
	...
	myClient, _ := encryption.NewKADPClient(url, token, "../log", "Kadp-log.txt")

	encrypt, err := myClient.FpeEncipher("1324abcd5648789光辉asdoaklamaz", algorithm.FF1, "1234567", "你木纹0123456789abcd光辉", 16, "kadp112", 2, 18)
	if err != nil {
		fmt.Println(err)
	}
	log.Println(encrypt)
	...
	asdas := "asd密文"
	decipher, err := myClient.FpeDecipher(encrypt, algorithm.FF1, "1234567", "你木纹0123456789abcd光辉", 16, "kadp112", 2, 18)
